...
WeixinRailsMiddleware.configure do |config|
  ...
  # config.weixin_token_string = '7f89e40fabca8bbc4098d88f'
  # using to weixin server url to validate the token can be trusted.
  # config.weixin_secret_string = 'hyFkiY4k9HpTHYk4LN-vl-MjUCLLMT2T'
  # 加密配置，如果需要加密，配置以下参数
  # config.encoding_aes_key = 'a3e9beee9a85a71bc135428fbecda6d47f59a3f6e9d'
